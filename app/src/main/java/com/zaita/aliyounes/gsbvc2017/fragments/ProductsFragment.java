...
public class ProductsFragment extends Fragment {
    ...
    private void setUpItemTouchHelper() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public int getSwipeDirs(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
                ...
                ProductsAdapter testAdapter = (ProductsAdapter) recyclerView.getAdapter();
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                ProductsAdapter adapter = (ProductsAdapter) recyclerView_products.getAdapter();
                boolean undoOn = true;
                if (undoOn) {
        ...
        mItemTouchHelper.attachToRecyclerView(recyclerView_products);
    }
    ...
    private void setUpAnimationDecoratorHelper() {
        recyclerView_products.addItemDecoration(new RecyclerView.ItemDecoration() {
