...
public class SuppliersFragment extends Fragment {
    ...
    private void setupRecyclerView() {
        ...
        recyclerView_suppliers.setHasFixedSize(true);
    ...
    private void setUpItemTouchHelper() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public int getSwipeDirs(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
                ...
                SuppliersAdapter testAdapter = (SuppliersAdapter) recyclerView.getAdapter();
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                SuppliersAdapter adapter = (SuppliersAdapter) recyclerView_suppliers.getAdapter();
                boolean undoOn = true;
                if (undoOn) {
        ...
        mItemTouchHelper.attachToRecyclerView(recyclerView_suppliers);
    }
    ...
    private void setUpAnimationDecoratorHelper() {
        recyclerView_suppliers.addItemDecoration(new RecyclerView.ItemDecoration() {
